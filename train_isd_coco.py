...
# paths
parser.add_argument('--checkpoint_path', default='./output_isd/', type=str,
...
def main(opt):
    ...
    model = ISD(key_model,query_model,
    ...
    for epoch in range(opt.start_epoch, opt.epochs + 1):
        ...
        save_file = os.path.join(opt.checkpoint_path, 'ckpt_epoch{epoch}_isd.pth'.format(epoch=epoch))
